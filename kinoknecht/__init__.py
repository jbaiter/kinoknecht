...
import lovely_jsonrpc.dispatcher, lovely_jsonrpc.wsgi
...
#        player_dispatcher = lovely_jsonrpc.dispatcher.JSONRPCDispatcher(self.player)
        ctrl_dispatcher = lovely_jsonrpc.dispatcher.JSONRPCDispatcher(self.controller)
